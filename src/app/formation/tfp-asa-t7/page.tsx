...
export default function TFPASAT7Brochure() {
  ...
  const objectives = [
    ...
    "Effectuer les contrôles de sûreté selon les procédures",
    "Utiliser les équipements de détection et de contrôle",
    "Gérer les situations d'urgence et les incidents",
    "Communiquer efficacement avec les passagers et les équipes",
    "Appliquer les gestes de premiers secours",
  ];

  const careerOpportunities = [
    "Agent de sûreté aéroportuaire T7 (inspection filtrage)",
    "Contrôleur d'accès en zone réservée",
    "Agent de sûreté fret et courrier",
    "Superviseur d'équipe de sûreté",
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <Section className="flex items-center justify-between py-4">
          ...
          <nav className="hidden md:flex items-center gap-6">
            ...
            <Button asChild variant="outline">
              <Link href="/inscription/tfp-asa-t7">S'inscrire</Link>
            </Button>
          </nav>
        </Section>
      </header>
        ...
        <Section className="relative py-16 md:py-24">
          <div className="max-w-4xl">
            ...
            <div className="flex items-center gap-2 mb-4">
              ...
              <Badge>Sûreté Aéroportuaire</Badge>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button
                ...
                className="shadow-lg"
              >
                <Link href="/inscription/tfp-asa-t7">S'inscrire maintenant</Link>
              </Button>
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            ...
            <p className="text-lg text-gray-700 mb-6">
              Le TFP ASA T7 (Titre à Finalité Professionnelle Agent de Sûreté Aéroportuaire Typologie 7) est une formation certifiante qui vous prépare aux métiers de la sûreté dans l'environnement aéroportuaire.
            </p>
            <p className="text-gray-700 mb-6">
              Cette formation complète vous donne toutes les compétences nécessaires pour exercer en tant qu'agent de sûreté aéroportuaire, avec une spécialisation dans l'inspection/filtrage des passagers et des bagages.
            </p>
            <div className="bg-red-50 p-6 rounded-lg">
              ...
              <p className="text-sm text-gray-700">
                Titre reconnu par l'État de niveau 3 (CAP/BEP) inscrit au RNCP, ouvrant droit à l'habilitation préfectorale.
              </p>
            </div>
          </div>
          <div>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="bg-white p-4 rounded-lg">
                  ...
                  <p className="text-sm text-gray-600">QCM sur la réglementation et les procédures de sûreté</p>
                </div>
                <div className="bg-white p-4 rounded-lg">
                  <h4 className="font-semibold mb-2">Épreuves pratiques</h4>
                  <p className="text-sm text-gray-600">Mise en situation professionnelle et manipulation d'équipements</p>
                </div>
                <div className="bg-white p-4 rounded-lg">
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-600">Matériel professionnel de sûreté</div>
                </div>
              </CardContent>
            </Card>
      ...
      <section className="bg-gradient-to-r from-red-900 to-red-700 text-white py-16">
        <Section className="text-center">
          <h2 className="text-3xl font-bold mb-4">Prêt à obtenir votre TFP ASA T7 ?</h2>
          <p className="text-xl mb-8 text-white/90">
            Rejoignez nos prochaines sessions et obtenez votre titre professionnel reconnu par l'État
          </p>
